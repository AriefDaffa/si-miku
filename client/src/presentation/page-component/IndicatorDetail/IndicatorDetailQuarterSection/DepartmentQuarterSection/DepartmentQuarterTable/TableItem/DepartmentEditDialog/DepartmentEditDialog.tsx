...
import useEditDepartmentDataMutation from '@/repository/mutation/department/EditDepartmentDataMutation';
...
interface DepartmentEditDialogProps extends IndicatorDepartmentsNormalized {
  open: boolean;
  indicatorID: number;
...
const DepartmentEditDialog: FC<DepartmentEditDialogProps> = (props) => {
  ...
  const { mutate, isError, error, isSuccess } = useEditDepartmentDataMutation();

  const { control, handleSubmit } = useForm({
    defaultValues: {
      q1: rest.targetDeps[0].targetQuarter.q1,
      q2: rest.targetDeps[0].targetQuarter.q2,
      q3: rest.targetDeps[0].targetQuarter.q3,
      q4: rest.targetDeps[0].targetQuarter.q4,
      target_value: rest.targetDeps[0].targetQuarter.targetValue,
    },
    resolver,
  });
  ...
  const handleOnSubmit = (data: {
    ...
    const { targetQuarter } = rest.targetDeps[0];
    const { departmentID } = rest.department;
