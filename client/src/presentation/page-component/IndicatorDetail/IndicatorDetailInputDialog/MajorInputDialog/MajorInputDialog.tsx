...
import MajorPicker from '@/presentation/page-component/common/MajorPicker';
...
interface MajorInputDialogProps {
  open: boolean;
  indicatorID: number;
...
const MajorInputDialog: FC<MajorInputDialogProps> = (props) => {
  const { open, setOpen, indicatorName, indicatorID, major } = props;
  ...
  const { mutate, isError, error, isSuccess } = useInputDataMajorMutation();
  ...
  const handleOnSubmit = (data: {
    ...
    const payload = {
      ...
      major_id: currentMajor,
      department_id: major[currentMajor - 1].major.departmentID,
      indicator_data: {
        q1,
        q2,
        q3,
...
export default MajorInputDialog;
