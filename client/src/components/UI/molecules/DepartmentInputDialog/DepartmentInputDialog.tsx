...
import DepartmentPicker from '@/components/UI/organism/DepartmentPicker';
...
interface DepartmentInputDialogProps {
  open: boolean;
  indicatorID: number;
...
const DepartmentInputDialog: FC<DepartmentInputDialogProps> = (props) => {
          ...
          <form onSubmit={handleSubmit(handleOnSubmit)}>
            <Stack gap={2} sx={{ my: 2 }}>
              <Grid
                ...
                gridItem={[
                  <Box>
                    <SubHeader text="Pilih Departemen" sx={{ pb: 1 }} />
                    <DepartmentPicker
